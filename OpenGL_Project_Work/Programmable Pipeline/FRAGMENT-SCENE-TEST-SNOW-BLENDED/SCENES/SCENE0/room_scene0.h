...
void RenderRoomScene0(mat4 ProjectionMatrix, GLfloat time)
{
	...
	translationMatrix 			= translate(0.0f, -2.0f, -2.0f);
	modelMatrix 				= translationMatrix;
	rotationMatrix				= rotate(/*rAngle_room_scene0*/270.0f, 0.0f, 1.0f, 0.0f);
...
void DeallocateRoomScene0(void)
{
	...
	for (int i = 0; i < MAX_OBJECTS_SCENE0; i++)
	{
		...
		fprintf(gpFile, "room_scene0-3.h");
		...
		fprintf(gpFile, "room_scene0-4.h");
		...
		fprintf(gpFile, "room_scene0-5.h");
		...
		fprintf(gpFile, "room_scene0-6.h");
		...
		fprintf(gpFile, "room_scene0-7.h");
		//delete textures
		...
		fprintf(gpFile, "room_scene0-8.h");
		models_room_scene0[i].pTextures.clear();
		fprintf(gpFile, "room_scene0-9.h");
		models_room_scene0[i].pGroups.clear();
		fprintf(gpFile, "room_scene0-10.h");
		models_room_scene0[i].pMaterials.clear();
		fprintf(gpFile, "room_scene0-11.h");
	}
